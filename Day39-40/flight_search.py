...
class FlightSearch:
    def __init__(self):
        ...
        self.api_sec=os.getenv("API_SEC")
    ...
    def get_destination_code(self,city_name):
        ...
        headera = {"Authorization": f"Bearer {self._token}"}
        query={
            "keyword":city_name,
            "max":2,
            "include":"AIRPORTS"
        }
        response=requests.get(url=IATA_ENDPOINT,headers=headera,params=query)
    ...
    def check_flights(self,origin_code,destination_code,from_time,to_time):
        ...
        """
         ...
         response=requests.get(url=FLIGHT_ENDPOINT,headers=headers,params=parameter)
